...
const CLOUD_URL = 'https://face-attendance-backend-atv0tcpw5-learnmades-projects.vercel.app';
...
const IS_DEV = false; // Set to true for local backend, false for Vercel
